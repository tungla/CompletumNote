package com.example.tungvu.completumnote;
...
import com.example.tungvu.completumnote.ToDoView.ToDoItem;
...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    // String contains command to create products table
    private static final String TODOTABLE = "CREATE TABLE " + TABLE_PRODUCTS + " (" +
            ...
            ");";
    // String contains command to create details table
    ...
    // onCreate is called when the app is opened for first time
    @Override
    ...
    // onUpgrade is called when the app is upgraded
    @Override
